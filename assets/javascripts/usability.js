...
RMPlus.Usability = (function (my) {
  ...
  my.thumbnails = function(el){
    if($(el).closest('.thumbnails').length > 0){
      return true
    }else{
      return false
    }
  ...
  my.createGallery = function (parent_element, gallery_name) {
    ...
    $('a', $(parent_element)).each(function () {
      var $this = $(this);
      if (my.fileIsImage(this.href) || my.thumbnails(this)) {
...
$(document).ready(function () {
  ...
  $(document).ajaxStart(function () {
    ...
    if (obj && obj.length > 0) {
      RMPlus.Utils.replace_with_loader(obj);
  ...
  $(document).ajaxStop(function () {
    RMPlus.Utils.restore_with_loader(jQuery('.ajax_hidden_emmiter'));
  });
