...
jsToolBar.prototype.us_colorMenu = function(fn){
  ...
  for (var i = 0; i < codeRayColor.length; i++) {
    $("<li data-color='" + codeRayColor[i] + "' style='background-color:" + codeRayColor[i] + "!important; color:" + codeRayColor[i] + "!important; border: none!important;'></li>").text(codeRayColor[i]).appendTo(menu).mousedown(function(){
